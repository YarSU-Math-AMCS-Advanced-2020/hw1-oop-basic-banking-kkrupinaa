...
bool DataBase::transaction(Account* write_off_account, Account* credit_account, const decimal<2>& amount)
{
...
bool DataBase::cash_transaction(Account* account, const decimal<2>& amount, const operation& operation)
{
